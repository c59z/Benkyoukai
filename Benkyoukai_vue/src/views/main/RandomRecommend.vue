<template>
  <div id="random-recommend">
    <h5 style="text-align: left;margin-top: 0.5rem" ><span class="badge rounded-pill text-bg-pink">{{$t("random_recommend")}}</span></h5>
...
export default {
      ...
      articles: [
        {
          ...
          "likeCount": 0,
          "createBy": 0,
          "avatar": "http://localhost:7777/img/avatar/1_1722851694416.jpg",
          "createTime": "2024-08-03T12:32:25.000+00:00"
        },
      ],
    }
  },
  methods: {
    getRandomRecommend(){
      request.get("/article/randomRecommend").then(res => {
